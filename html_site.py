...
body {
  ...
  line-height: 1.5;
  background:
    radial-gradient(1200px 700px at 85% -10%, rgba(0,197,108,0.18), transparent 55%),
    radial-gradient(900px 500px at -10% 30%, rgba(255,77,26,0.08), transparent 50%),
...
.badge {
  ...
  background: rgba(0,197,108,0.16);
  border: 1px solid rgba(0,197,108,0.35);
}
...
.filters button.active {
  color: var(--accent-ink);
  border-color: var(--accent);
  background: rgba(0,197,108,0.14);
}
...
.preview-strip .more-link:hover { color: var(--accent-ink); }
...
.search-box input:focus {
  border-color: var(--accent);
  box-shadow: 0 0 0 3px rgba(0,197,108,0.22);
}
